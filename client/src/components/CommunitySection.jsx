                        ...
                        <div className="md:w-1/2 p-8">
                            ...
                            <div className="space-x-4">
                                <button
                                    ...
                                    className="bg-primary text-white px-6 py-3 rounded-lg hover:bg-primary-dull transition-colors font-semibold"
                                >
                                    Explore Community
                                </button>
                                {user && (
                                    <button
                                        ...
                                        className="border border-primary-dull text-primary px-6 py-3 rounded-lg hover:bg-green-50 transition-colors font-semibold"
                                    >
                                        My Posts
                                    </button>
                                )}
